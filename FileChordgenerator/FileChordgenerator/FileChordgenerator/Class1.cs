...
namespace FileChordgenerator
{
    public class Class1
    {
        ...
        public void getdata()
        {
            ...
            FileStream fs = new FileStream(@"C:\Users\Subham Kumar Ojha\Desktop\FileChordgenerator\test.txt", FileMode.Create, FileAccess.Write);
